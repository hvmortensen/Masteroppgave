...
### Første måling i hver kohorte i forhold til gennemsnittet af kohorten
# plt.plot(h190[:5]/np.mean(h190[:5]))
# plt.plot(h190[5:]/np.mean(h190[5:]))
# plt.plot(h191/np.mean(h191))
# plt.plot(h193/np.mean(h193))
# plt.plot(h195/np.mean(h195))
# plt.plot(h19x/np.mean(h19x))
# plt.plot(p190[:5]/np.mean(p190[:5]))
# plt.plot(p190[5:]/np.mean(p190[5:]))
# plt.plot(p191/np.mean(p191))
# plt.plot(p193/np.mean(p193))
# plt.plot(p192/np.mean(p192))
# plt.plot(p19x/np.mean(p19x))
#
# plt.plot(h110/np.mean(h110))
# plt.plot(h111/np.mean(h111))
# plt.plot(h112/np.mean(h112))
# plt.plot(h113/np.mean(h113))
# plt.plot(h115/np.mean(h115))
# plt.plot(h11x/np.mean(h11x))
# plt.plot(p110/np.mean(p110))
# plt.plot(p111/np.mean(p111))
# plt.plot(p112/np.mean(p112))
# plt.plot(p113/np.mean(p113))
# plt.plot(p115/np.mean(p115))
# plt.plot(p11x/np.mean(p11x))
#
# plt.plot(h100/np.mean(h100))
# plt.plot(h101/np.mean(h101))
# plt.plot(h102/np.mean(h102))
# plt.plot(h103/np.mean(h103))
# plt.plot(h105/np.mean(h105))
# plt.plot(h10x/np.mean(h10x))
# plt.plot(p100/np.mean(p100))
# plt.plot(p101/np.mean(p101))
# plt.plot(p102/np.mean(p102))
# plt.plot(p103/np.mean(p103))
# plt.plot(p105/np.mean(p105))
# plt.plot(p10x/np.mean(p10x))
